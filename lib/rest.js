...
_.extend(Rest.prototype, {
  ...
  detail: function(item) {
    var Model = this.Model
      , resource  = this.resource
      , opts  = this.opts
      , beforeActions = this.beforeActions(item, resource)
      , args
      , action = function(req, res, next) {
